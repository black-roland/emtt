...
### Для участников сообщества (Boosty)

EMtT — это результат моих экспериментов с Meshtastic. Если вы хотите:
- Поддержать развитие таких проектов;
- Получить готовые сборки без возни с компиляцией;
- И влиять на новые фичи;
<!-- - И влиять на то, какие фичи появятся следующими; -->
<!-- - Обсуждать инженерные решения в закрытом чате; -->

То присоединяйтесь к [сообществу на Boosty](https://boosty.to/mansmarthome/posts/ca2ddb88-d808-419b-8faf-5d5619f66b95). В благодарность за поддержку вы получите доступ к:
...
- Статическим бинарникам для Linux и Windows.
- Подробной документации.
- Прямой связи со мной для вопросов.
